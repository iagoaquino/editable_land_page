...
def mesclate_text(css_text_to_mesclate):
    ...
    --third-color:{css_text_to_mesclate['third_color']};--primary-font-color: {css_text_to_mesclate['primary_font_color']};--secondary-font-color: {css_text_to_mesclate['secondary_font_color']};\
